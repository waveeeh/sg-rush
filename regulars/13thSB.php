...
<head>
    ...
    <title>13th Regular Sessions | Sanggunian ng Bongabon</title>
...
<section class="py-12 bg-white">
    <div class="container mx-auto px-4">
        <div class="text-center max-w-3xl mx-auto mb-8">
            <h2 class="text-3xl md:text-4xl font-bold text-dark mb-4">13th Sangguniang Bayan</h2>
...
<section class="py-12 bg-white">
    <div class="container mx-auto px-4">
        <div class="text-start max-w-3xl mx-auto mb-8">
            <h1 class="text-xl md:text-xl font-bold text-dark mb-4">DOWNLOAD (PDF)</h1>
            <div class="h-1 w-20 bg-primary mx-1 mb-6"></div>
