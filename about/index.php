    ...
    <section class="text-gray-600 body-font">
        <div class="container px-5 py-12 mx-auto">
            <div class="text-center max-w-3xl mx-auto mb-16">
                <h2 class="text-3xl md:text-4xl font-bold text-dark mb-4"> Council Members</h2>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            <div class="text-center max-w-3xl mx-auto mb-12">
                <h2 class="text-3xl md:text-4xl font-bold text-dark mb-4">How Ordinances and Other Measures Are Enacted</h2>
                <div class="h-1 w-20 bg-primary mx-auto mb-6"></div>
                <p class="text-gray-600">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Labore sint iure, eos illum consequatur, veritatis aliquam rem, nobis quidem qui est tenetur quam culpa at eligendi expedita dicta harum excepturi?</p>
            </div>
