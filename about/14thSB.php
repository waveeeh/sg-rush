...
<head>
    ...
    <title>14th | Sanggunian ng Bongabon</title>
...
<body class="bg-gray-100">
    ...
    <div class="max-w-8xl mx-auto py-12 ">
        ...
        <div class="text-center mb-6">
            <h2 class="text-2xl font-bold text-gray-800 mb-2">Members of the 14th Sanggunian</h2>
    ...
    <section class="text-gray-600 body-font">
        <div class="container px-5 py-2 mx-auto">
            ...
            <h1 class="text-2xl font-medium title-font mb-4 text-gray-900">The Councilors</h1>
